...
{{-- @section('title', 'Rupa Collective - Temukan Gaya Unikmu') --}}
...
@section('content')
    ...
    <div class="relative bg-gradient-to-r from-gray-800 to-gray-900 text-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-20" style="background-image: url('https://placehold.co/1920x1080/000000/FFFFFF?text=Rupa+Collective'); background-size: cover; background-position: center;"></div>
        <div class="relative z-10 max-w-4xl mx-auto text-center">
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight mb-4 animate-fade-in-up">
                Temukan Gaya Unikmu di Rupa Collective
            </h1>
    ...
    <footer class="bg-gray-900 text-gray-300 py-10 mt-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white mb-4">Rupa Collective</h3>
                    <p class="text-sm">
                        Temukan gaya unikmu dengan koleksi fashion terbaru dari Rupa Collective. Kualitas premium, desain eksklusif.
                    </p>
                ...
                <div>
                    ...
                    <p class="text-sm mb-2">Email: info@Rupa Collective.com</p>
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-500">
                &copy; {{ date('Y') }} Rupa Collective. All rights reserved.
            </div>
        </div>
    </footer>
@endsection