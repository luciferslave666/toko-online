...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8" id="product-catalog"> {{-- Added ID for smooth scroll from hero --}}
    ...
    <footer class="bg-gray-900 text-gray-300 py-10 mt-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white mb-4">NOCTVIBE</h3>
                    <p class="text-sm">
                        Temukan gaya unikmu dengan koleksi fashion terbaru dari NOCTVIBE. Kualitas premium, desain eksklusif.
                    </p>
                    <div class="flex space-x-4 mt-4">
                        {{-- Contoh Ikon Media Sosial (bisa diganti dengan SVG atau Font Awesome) --}}
                        ...
                        <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.002 3.797.048.843.04 1.15.137 1.243.157.607.125.93.356 1.18.607.25.25.488.587.607 1.18.02.093.117.40.157 1.243.046 1.013.048 1.376.048 3.797v.648c0 2.43-.002 2.784-.048 3.797-.04.843-.137 1.15-.157 1.243-.125.607-.356.93-.607 1.18-.25.25-.587.488-1.18.607-.093.02-.4.117-1.243.157-1.013.046-1.376.048-3.797.048h-.648c-2.43 0-2.784-.002-3.797-.048-.843-.04-1.15-.137-1.243-.157-.607-.125-.93-.356-1.18-.607-.25-.25-.488-.587-.607-1.18-.02-.093-.117-.4-.157-1.243-.046-1.013-.048-1.376-.048-3.797v-.648c0-2.43.002-2.784.048-3.797.04-.843.137-1.15.157-1.243.125-.607.356-.93.607-1.18.25-.25.587-.488.607-1.18.02-.093.117-.4.157-1.243.046-1.013.048-1.376.048-3.797v-.648zM12 20.211c-4.508 0-8.147-3.639-8.147-8.147s3.639-8.147 8.147-8.147 8.147 3.639 8.147 8.147-3.639 8.147-8.147 8.147zm0-14.594c-3.584 0-6.49 2.906-6.49 6.49s2.906 6.49 6.49 6.49 6.49-2.906 6.49-6.49-2.906-6.49-6.49-6.49zm5.343 1.957a1.22 1.22 0 100 2.44 1.22 1.22 0 000-2.44z" clip-rule="evenodd" />
                            </svg>
                        </a>
